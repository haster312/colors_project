  ...
  <b-container fluid>
    <section>
      ...
      <div class="text-center">
        ...
        <b-button class="btn-general mb-3" @click="createNewCollection">Create new collection</b-button>
      </div>
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      createCollectionByRecommendation: "Recommendation/createCollectionByRecommendation"
    }),
    openProducts(id) {
    ...
    createNewCollection() {
      ...
      this.createCollectionByRecommendation({ ...this.recommendations[0], title: "First Collection" });
      this.$router.push({ name: "TryOn" });
    },
  },
};
